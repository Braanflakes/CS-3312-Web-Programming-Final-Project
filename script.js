...
document.addEventListener('DOMContentLoaded', function () {
   ...
   (function () {
      ...
      (function () {
         ...
         textArea.textContent += 'Bottom (n - X): Takes the bottom (n - X) dice in your roll.\n\n';
         ...
         updateCanvas = function (value) {
            ...
            // Initialize vars
            /*if (document.querySelector('#modifier-none').checked) {
               numOfBars = (quantity * die) - (quantity - 1);
            } else if (document.querySelector('#modifier-top').checked) {
               numOfBars = ((quantity - document.querySelector('#modifier-top').value) * die) - (quantity - 1);
            } else {
               numOfBars = ((quantity - document.querySelector('#modifier-bottom').value) * die) - (quantity - 1);
            }*/
